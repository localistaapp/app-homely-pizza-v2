...
class Dashboard extends Component {
    ...
    render() {
        const accordionList = [{ title: {__html: 'Dough, pizza par-baking & baking'} }, { title: {__html: 'Vegetable chopping & counter readiness'} }, { title: {__html: 'Hygiene & Safety' }}, { title: {__html: 'Handling Equipment Safely, Efficiently & Appropriately' }}, { title: {__html: 'Presentation & Communication' }}, { title: {__html: 'Day-to-Day Process Checklist' }}];
        ...
        return (<div style={{marginTop: '84px'}}>
                    ...
                    <Paper>
                                              ...
                                              <TabPanel value={this.state.value} index={0}>
                                                   <span className="stage-heading" style={{top: '12px'}}><StoreIcon />&nbsp;&nbsp;Operator Onboarding</span>

        ...
        return (<div style={{marginTop: '84px'}}>
                    ...
                    <Paper>
                                              ...
                                              <TabPanel value={this.state.value} index={0}>
                                                   <span className="stage-heading" style={{top: '12px',background: '#f6f6f6'}}><OrdersIcon />&nbsp;&nbsp;Create Enquiry</span>
                                                   ...
                                                   <br/>
                                                   <a className="button" onClick={this.createEnquiryOrder} style={{position:'absolute'}}>Create Enquiry →</a>
                                                   <br/><br/><br/><br/>
...
export default withRouter(CreateEnquiry);
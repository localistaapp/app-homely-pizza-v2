...
class Content extends Component {
    ...
    render() {
        ...
        return (<div style={{marginTop: '84px'}}>
                    <img id="logo" className="logo-img" src="../img/images/logo_scr.jpg" style={{width: '142px',position: 'absolute'}} onClick={()=>{window.location.href='/app';}} />
                    ...
                    <Paper>
                                              <TabPanel value={this.state.value} index={0}>
                                                <div className='content-elem'>
                                                    <div className="content-back" onClick={()=>{window.location.href='/app'}}>← Back to Home</div>
